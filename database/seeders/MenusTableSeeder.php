...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $this->insertLink('admin', 'Mobil',                   '/cars');
        $this->insertLink('admin', 'Transaksi',                   '/transactions');
        ...
        $id = $this->insertLink('admin', 'Mobil',                   '/cars');
        $id = $this->insertLink('admin', 'Transaksi',                   '/transactions');
        $this->endDropdown();
